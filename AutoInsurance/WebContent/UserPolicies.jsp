        			...
        			<section class='container p-4'>
			    		...
			    		%>	
			    			<div class='bg-light p-2'>
			    				<p>
			    				Policy ID: <b style="margin-right:12px;"><%=policy.get("pid") %></b>
    							Policy Name: <b style="margin-right:12px;"><%=policy.get("p_name") %></b>
    							Sum Insured Amount: <b style="margin-right:12px;"><%=policy.get("p_si_amt") %></b>
			    				Category: <b><%=policy.get("category") %></b></p>
			    			...
			    			<!-- <h4 style="color:#185f80;font-size:20px">Usre Detail:-</h4> -->	
			    				<p>
			    				<img src='GetPhoto?email=<%=u_email%>&type=user' height='100' align="right" style="margin-right:650px;"/>
			    				Name: <b><%=user.get("name") %> </b> <br>
			    				Email: <b><%=u_email %></b><br>
			    				Phone: <b><%=user.get("phone") %></b><br>
			    				Address: <b><%=user.get("address") %></b><br>
			    				</p>
			    				<hr/>
			    			</div>
			    		<%	
