        ...
        <section class="my-5">
          <div class="container">
            <div class="row align-items-center">
              ...
              <div class="col-md-6">
                  <p><i class="fas fa-map-marker-alt"></i>102 Techvila (Near DTC) Knowledge Park 3rd , Geater Noida, UP (201306).</p>
                  <p><i class="fas fa-mobile-alt"></i> 6306732652 , 7703077171.</p>
                  <p><i class="fas fa-envelope"></i> akashinsurance1210@gmail.com</p>
                  <hr/>
                  <h5>Send Feedback! Fill the form please.</h5>
