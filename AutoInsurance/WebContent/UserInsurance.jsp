        ...
        <div class='container p-4'>
    		...
    		%>	
    			<div class='bg-light p-3' >
    				...
    				Company Name : <b><%=company_details.get("name") %></b>
    				Company Phone : <b><%=company_details.get("phone") %></b>
    				Company Email : <b><%=c_email %></b>
    				</p>
    				...
    				<p>
    				Policy ID : <b><%=pid %></b><br>
    				Policy Order ID : <b><%=oid %></b><br>
    				Policy Name : <b><%=p_name %></b><br>
    				Sum Insured Amount : <b><%=p_si_amt %></b><br>
    				Description : <b><%=p_desc %></b><br>
    				</p>
        	...
        	%>
        	<button class="btn btn-dark "><a href="index.jsp" style="font-size:40px;font-family:arial">Home</a></button>
      		<button class="btn btn-dark "><a href="UserHome.jsp" style="font-size:40px;font-family:arial">Back</a></button>
       	</div>
